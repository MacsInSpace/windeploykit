...
`docs/windeploykit_ui_mockup.html`). Its §6 already codifies the tooltip rule — apply it strictly:
...
Locked in with the shell build — see style guide §1 *Non-negotiables*:
